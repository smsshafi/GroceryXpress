...
<?php $page_title = 'Modify Categories'; ?>
<?php echo $sDocType; ?>
	...
	<head>
		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
				...
				var requestHandler = "categoryHandler.php";
	...
	<div class="content">
		...
		<form id="frm_editdelete">
			...
			<div id="question" class="hidden"> 
				...
				category?</div> <input type="button" id="yes" 
